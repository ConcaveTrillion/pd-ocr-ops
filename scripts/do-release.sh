...
echo "   Watch the release workflow: https://github.com/pdomain/pdomain-ops/actions"
echo "   Release page (once workflow finishes): https://github.com/pdomain/pdomain-ops/releases/tag/$VERSION"
